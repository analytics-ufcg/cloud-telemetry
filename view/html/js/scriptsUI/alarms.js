...
//valor de threshold
html_addalarm += '<div class="row"><div class="col-lg-8 col-md-8">Threshold  <input type="text" id="parametro" name="param_val"></input></div>';
...
html_addalarm += '<div class="row"><div class="col-lg-8 col-md-8">Time  <input type="text" id="time" name="time_val"></input></div></div>'
